<?php
$valeurTotalStock = $valeurTotalStock ?? 0;
$nbrProduit = $nbrProduit ?? 0;
$nbrClient = $nbrClient ?? 0;
?>
        ...
        <div id="view-pos" class="view-section">
            ...
            <div style="display: grid; grid-template-columns: 600px 1fr; gap: 32px; align-items: start; margin-bottom: 32px;">
                ...
                <div class="panel-card" style="margin-bottom: 0; padding: 24px; border: 1px solid rgba(59, 130, 246, 0.2); background: linear-gradient(180deg, rgba(17, 24, 43, 0.5) 0%, rgba(10, 15, 30, 0.3) 100%); position: sticky; top: 24px;">
                    ...
                    <form method="POST" action="." onsubmit="event.preventDefault(); alert('Action enregistrée (mode démonstration HTML/CSS)');" action="" id="order-creation-form">
                        ...
                        <div class="form-group">
                            ...
                            <div style="position: relative;">
                                <select name="client_id" id="client-select" class="form-control" style="width: 100%; appearance: none; padding-right: 30px;" onchange="updateClientLimitInfo()">
                                   ...
                                   <option value="6" data-limit="300000"> <?=$client['prenom'].' '.$client['nom']?> (<?=$client['tel']?>)  </option>
                                   <?php endforeach?>
                                 </select>
                    ...
                    <table class="debt-table" id="orders-main-table">
                        ...
                        <tbody>
                            <?php 
                              ...
                              <tr>
                                 <td style="font-weight: 700; color: var(--text-muted);"><?=$commande['ref']?></td>
                                    <td style="font-weight: 700;">
                                        <?=$commande['nomcomplet']?>                                        
                                        <div style="font-size:11px; color:var(--text-muted); font-weight:normal;">Tél : <?=$commande['tel']?></div>
                                    </td>
                                    <td style="font-weight: 800; color: var(--accent);"><?=$commande['montant_total']?> F</td>
                                    <td>
                                      <span class="badge badge-danger"><?=$commande['reglement']?></span>                                                                                   </td>
                                    <td>
        ...
        <div id="view-catalog" class="view-section">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 24px;">
                <div class="panel-card" style="padding: 16px; display: flex; align-items: center; justify-content: space-between; border-left: 4px solid var(--success);">
                    <div>
                        ...
                        <div style="font-size: 18px; font-weight: 800; color: white; margin-top: 4px;"><?=$valeurTotalStock?> F</div>
                    </div>
                    <span style="font-size: 24px;">📦</span>
                </div>
                <div class="panel-card" style="padding: 16px; display: flex; align-items: center; justify-content: space-between; border-left: 4px solid var(--accent);">
                    <div>
                        ...
                        <div style="font-size: 18px; font-weight: 800; color: white; margin-top: 4px;"><?=$nbrProduit?> références</div>
                    </div>
                ...
                <div class="panel-card" style="padding: 16px; display: flex; align-items: center; justify-content: space-between; border-left: 4px solid var(--warning);">
                    <div>
                        ...
                        <div style="font-size: 18px; font-weight: 800; color: white; margin-top: 4px;"><?=$nbrClient?> clients</div>
                    </div>
                    <span style="font-size: 24px;">👥</span>
                </div>
            </div>
            ...
            <div id="catalog-panel-products" style="display: grid; grid-template-columns: 600px 1fr; gap: 32px; align-items: start;">
                ...
                <div class="panel-card" style="margin-bottom: 0;">
                    ...
                    <form method="POST" action="http://localhost:8000/showProduitTiers">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="prix_vente" class="form-control" placeholder="Ex: 12000" min="0" required>
                        </div>
                        <div class="form-group">
                            <label for="quantite_stock">Stock Initial</label>
                            <input type="number" name="stock" class="form-control" placeholder="Ex: 50" min="0" required>
                        </div>
                        <button type="submit" name = "btnPOS" value="saveProduit" class="btn-submit btn-success" style="width: 100%;">Enregistrer le Produit (DML)</button>
                    </form>
                </div>
                ...
                <div class="panel-card" style="margin-bottom: 0;">
                    ...
                    <form method="POST" action="http://localhost:8000/showProduitTiers" >
                        ...
                        <div class="form-group" style="margin-top: 12px;">
                            ...
                            <input type="text" name="tel" class="form-control" placeholder="Ex: 776543210" required>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="btnPOS" value="saveClient" class="btn-submit" style="width: 100%;">Créer le Compte Client (DML)</button>
                    </form>
                </div>
                    ...
                    <table class="debt-table" id="clients-main-table" style="font-size: 12px;">
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach ($clients as  $client):?>
                                <tr>
                                    <td style="font-weight: 700;"><?= $client->getNom() ." ".$client->getPrenom()?></td>
                                    <td><?=$client->getTel()?></td>
                                    <td style="font-weight: 700; color: var(--accent);"><?=$client->getLimite_credit()?> F</td>
                                </tr>
                               <?php endforeach?> 
                        </tbody>
                    </table>
            ...
            <div id="catalog-panel-suppliers" style="display: none; grid-template-columns: 600px 1fr; gap: 32px; align-items: start;">
                ...
                <div class="panel-card" style="margin-bottom: 0;">
                    ...
                    <form method="POST" action="http://localhost:8000/showProduitTiers">
                        ...
                        <div class="form-group">
                            <label for="telephone">Téléphone</label>
                            <input type="text" name="tel" class="form-control" placeholder="Ex: 338245678" required>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name ="btnPOS" value="saveFournisseur" class="btn-submit" style="width: 100%;">Créer le Fournisseur (DML)</button>
                    </form>
                </div>
