...
CREATE TABLE produits (
    ...
    seuil INTEGER NOT NULL DEFAULT 5 CHECK (seuil >= 0)
);
...
CREATE TABLE commandes (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    date_commande TEXT DEFAULT (date('now'))    montant_total REAL NOT NULL CHECK (montant_total >= 0),
...
CREATE TABLE approvisionnements (
    ...
    date_appro TEXT DEFAULT (date('now')),
